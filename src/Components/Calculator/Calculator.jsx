...
export const Calculator = () => {
  ...
  return (
    <Container>
      ...
      {theme === "dark" ? <Button roxo onClick={porcentage}><RiPercentLine size={"24px"}/></Button> : <Button branco onClick={porcentage}><RiPercentLine size={"24px"}/></Button>}

      {theme === "dark" ? <Button roxo onClick={()=> valueIcons("/")}><RiDivideLine size={"34px"} /></Button> :  <Button branco onClick={()=> valueIcons("/")}><RiDivideLine size={"34px"}/></Button>}
      ...
      {theme === "dark" ?  <Button roxo onClick={()=> valueIcons("x")}><RiCloseLine size={"34px"}/></Button> :  <Button branco onClick={()=> valueIcons("x")}><RiCloseLine size={"34px"}/></Button>}
      ...
      {theme === "dark" ?  <Button roxo onClick={()=> valueIcons("-")}><RiSubtractLine size={"34px"}/></Button> :  <Button branco onClick={()=> valueIcons("-")}><RiSubtractLine size={"34px"}/></Button>}
      ...
      {theme === "dark" ?  <Button roxo onClick={()=> valueIcons("+")}><RiAddLine size={"34px"}/></Button> :  <Button branco onClick={()=> valueIcons("+")}><RiAddLine size={"34px"}/></Button>}

      {theme === "dark" ?  <Button roxo onClick={deleteNumbers}><RiDeleteBack2Line size={"24px"}/></Button> : <Button branco onClick={deleteNumbers}><RiDeleteBack2Line size={"24px"}/></Button>}

      {theme === "dark" ?  <Button roxoNumber onClick={valueNumber} value={0}>0</Button> : <Button onClick={valueNumber} value={0}>0</Button>}

      {theme === "dark" ?  <Button roxo onClick={()=> valueIcons(".")}><TbWifi0 size={"40px"} /></Button> : <Button branco onClick={()=> valueIcons(".")}><TbWifi0 size={"40px"}/></Button>}

      {theme === "dark" ? <Button roxoNumber onClick={calculator}><TbEqual size={"24px"}/></Button> : <Button roxo onClick={calculator}><TbEqual size={"24px"}/></Button>}
      </ButtonsContainer>
    </Container>
  )
}
